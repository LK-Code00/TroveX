            ...
            <div className={`drawer ${open ? 'open' : ''}`}>
                <div className="drawer-header">
                    ...
                    <div className="drawer-user-info">
                        ...
                        <div className="drawer-photo-hint">
    ...
    if (value)
        return (
            <div className="img-uploader-preview">
                ...
                />
                <button className="img-uploader-remove" onClick={handleRemove}>
                    ✕ Remover
                </button>
            </div>
        );
    ...
    return (
        <div className="detail-page">
            ...
            <div className="detail-actions">
                ...
                {isLink && (
                    <button
                        className="detail-btn-link"
                        onClick={() =>
                            window.open(script.content.trim(), '_blank')
                        }
                    >
                        <svg
                            width="16"
...
export default function App() {
    ...
    async function fetchScripts() {
        ...
        try {
            ...
            setDbError(
                err?.message || JSON.stringify(err) || 'Erro desconhecido',
            );
        } finally {
            setLoading(false);
        }
    ...
    async function updateScript(id, data) {
        ...
        if (!error) {
            ...
            if (selectedScript?.id === id)
                setSelectedScript((prev) => ({ ...prev, ...data }));
        ...
        <div className="container">
            ...
            <div className="header">
                ...
                <p className="header-sub">
                    Seu cofre pessoal de links e scripts
                </p>
            </div>
            ...
            <div className="grid">
                {loading && (
                    <div className="empty-state">
                        <span className="icon">⏳</span>Carregando scripts...
                    </div>
                )}
                {!loading && dbError && (
                    <div className="empty-state">
                ...
                {!loading && !dbError && filtered.length === 0 && (
                    <div className="empty-state">
                        <span className="icon">📭</span>Nenhum script
                        encontrado.
                        {isAdmin && (
                            <>
                                <br />
                                Adicione seu primeiro script acima!
                            </>
                        )}
                    </div>
                )}
